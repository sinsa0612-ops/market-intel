...
#
# 2026-08-20 2차 보강(CEO 승인). 목적이 다르다 — 앞의 셋은 "계기가 없어 안 보이던
# 주도 업종"을 넣은 것이고, 이 여섯은 **한국 업종 커버리지의 빈 축**을 메운다.
# 미국은 SPDR 11개가 GICS 11개 섹터를 전부 덮는데 한국은 8개뿐이라 운수장비·
# 건설·은행·IT·2차전지·미디어가 통째로 비어 있었다.
#
# 공식 경로(KRX `idx/kospi_dd_trd`)는 401 Unauthorized다 — 키에 「지수」 권한이
# 없다. 지수 서비스를 신청하면 ETF에서 지수로 갈아탈 수 있다.
ADDED_KR_SECTOR_INDICES = {
    "449450.KS": "방산", "466920.KS": "조선", "487240.KS": "AI전력설비",
    "139260.KS": "IT", "091180.KS": "자동차", "091170.KS": "은행",
    "117700.KS": "건설", "228810.KS": "미디어", "266370.KS": "2차전지",
}
